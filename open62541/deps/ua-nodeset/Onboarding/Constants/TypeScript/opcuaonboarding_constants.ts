...
export class BrowseNames {
   static readonly AddApplication: string = 'AddApplication'
   static readonly AddEndpoint: string = 'AddEndpoint'
   static readonly AddIdentity: string = 'AddIdentity'
   static readonly Administration: string = 'Administration'
   static readonly Applications: string = 'Applications'
   static readonly ApplicationsExclude: string = 'ApplicationsExclude'
   static readonly BaseTicketType: string = 'BaseTicketType'
   static readonly Certificate: string = 'Certificate'
   static readonly CertificateAuthorityType: string = 'CertificateAuthorityType'
   static readonly Composite: string = 'Composite'
   static readonly CompositeIdentityTicketType: string = 'CompositeIdentityTicketType'
   static readonly CustomConfiguration: string = 'CustomConfiguration'
   static readonly DeviceIdentityAcceptedAuditEventType: string = 'DeviceIdentityAcceptedAuditEventType'
   static readonly DeviceIdentityAuthorities: string = 'DeviceIdentityAuthorities'
   static readonly DeviceIdentityTicketType: string = 'DeviceIdentityTicketType'
   static readonly DeviceRegistrar: string = 'DeviceRegistrar'
   static readonly DeviceRegistrarAdminType: string = 'DeviceRegistrarAdminType'
   static readonly DeviceRegistrarType: string = 'DeviceRegistrarType'
   static readonly DeviceRegistrationAuditEventType: string = 'DeviceRegistrationAuditEventType'
   static readonly DeviceSoftwareUpdatedAuditEventType: string = 'DeviceSoftwareUpdatedAuditEventType'
   static readonly Endpoints: string = 'Endpoints'
   static readonly EndpointsExclude: string = 'EndpointsExclude'
   static readonly GetManagers: string = 'GetManagers'
   static readonly ManagerDescription: string = 'ManagerDescription'
   static readonly ModelVersion: string = 'ModelVersion'
   static readonly OpcUaOnboarding_BinarySchema: string = 'Opc.Ua.Onboarding'
   static readonly OpcUaOnboarding_XmlSchema: string = 'Opc.Ua.Onboarding'
   static readonly OPCUAOnboardingNamespaceMetadata: string = 'http://opcfoundation.org/UA/Onboarding/'
   static readonly ProductInstanceUri: string = 'ProductInstanceUri'
   static readonly ProvideIdentities: string = 'ProvideIdentities'
   static readonly RegisterDeviceEndpoint: string = 'RegisterDeviceEndpoint'
   static readonly RegisterManagedApplication: string = 'RegisterManagedApplication'
   static readonly RegisterTickets: string = 'RegisterTickets'
   static readonly RemoveApplication: string = 'RemoveApplication'
   static readonly RemoveEndpoint: string = 'RemoveEndpoint'
   static readonly RemoveIdentity: string = 'RemoveIdentity'
   ...
   static readonly TicketAuthorities: string = 'TicketAuthorities'
   static readonly TicketListType: string = 'TicketListType'
   static readonly UnregisterTickets: string = 'UnregisterTickets'
   static readonly UpdateSoftwareStatus: string = 'UpdateSoftwareStatus'
   static readonly WellKnownRole_RegistrarAdmin: string = 'RegistrarAdmin'
}
